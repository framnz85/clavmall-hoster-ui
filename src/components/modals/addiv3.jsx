...
const Addiv3Modal = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (type === "add") {
        await httpAddiv3.postAddiv3({ name }, couid, addiv1, addiv2, coucode);
      } else if (type === "edit") {
        await httpAddiv3.putAddiv3(inputValues, couid, addiv1, addiv2, coucode);
      } else if (type === "delete") {
        await httpAddiv3.deleteAddiv3(
          inputValues,
          couid,
          addiv1,
          addiv2,
